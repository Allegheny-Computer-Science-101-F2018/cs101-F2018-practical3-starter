...
# cs101-F2018-practical3-solution

Designed for use with [GitHub Classroom](https://classroom.github.com/), this
repository contains the solution for Practical 3 in Computer Science 101.
...
- practicalthree/BubbleSort.java:
  ...
  - Produces output that contains exactly two of the fragment `F`
  - Produces output that contains exactly four of the fragment `4`
  - Passes all of the test cases defined in the `TestBubbleSort.java` file.
...
```
git remote add download git@github.com:Allegheny-Computer-Science-101-F2018/cs101-F2018-practical3-starter.git
```
...
Starter](https://github.com/Allegheny-Computer-Science-101-F2018/cs101-F2018-practical3-starter)
